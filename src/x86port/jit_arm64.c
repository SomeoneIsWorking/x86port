 ...
 * argument setup does not itself overwrite role registers. X10..X15 remain
 * caller-saved under AAPCS64 and must be dead or recomputed across a helper
 * call; only CPU_REG=X19 is callee-saved. See jit_arm64_internal.h.
 */
#include "jit_x64.h"
...
/* The common x87 shape/precision predicates live in jit_x87_predicates.c. */
