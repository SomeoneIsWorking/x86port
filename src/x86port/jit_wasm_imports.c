...
static const X86pWasmImportDesc kImports[kX86pWasmImportCount] = {
    ...
    [kX86pWasmImportX87Load] = {"wasm_x87_load", (X86pWasmImportFn)x86p_wasm_x87_load, 5, 1},
    [kX86pWasmImportX87Store] = {"wasm_x87_store", (X86pWasmImportFn)x86p_wasm_x87_store, 5, 1},
    [kX86pWasmImportX87ArithMem] = {"wasm_x87_arith_mem", (X86pWasmImportFn)x86p_wasm_x87_arith_mem, 7, 1},
    [kX86pWasmImportX87ArithReg] = {"wasm_x87_arith_reg", (X86pWasmImportFn)x86p_wasm_x87_arith_reg, 5, 1},
    [kX86pWasmImportX87CompareMem] = {"wasm_x87_compare_mem", (X86pWasmImportFn)x86p_wasm_x87_compare_mem, 5, 1},
    [kX86pWasmImportX87Copy] = {"wasm_x87_copy", (X86pWasmImportFn)x86p_wasm_x87_copy, 4, 1},
