 ...
 *
 * See jit_arm64_x87.h for the scope; the predicates are copied verbatim from
 * jit_x64_x87.c (pure decode-level shape checks, no host content at all).
...
/* ---- predicates ----------------------------------------------------------
 * Copied verbatim from jit_x64_x87.c: pure X86pInsn/X86pOperand shape
 * checks, with no host-register content, so the translatable set is
 * identical on both backends by construction. See jit_x64_x87.c for the
